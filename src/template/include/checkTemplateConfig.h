...
#ifndef ADSP_PROCESSOR_CLASS_NAME
#error "ADSP_PROCESSOR_INCLUDE_FILENAME was not defined! Please define the name of your include file in <Your Directory>/template/configuration/templateConfiguration.h"
#endif
