...
ADSP_INRESMOD_MODE_NUM adspInResampleModeNum[ADSP_MAX_INRES_MODES] = {INPUT_RESAMPLE_ID};
...
ADSP_POSTMOD_STR_NAMES adspPostStrNames[ADSP_MAX_POST_MODES][AE_DSP_ADDON_STRING_LENGTH] = {"Postprocess Mode 1"};

ADSP_POSTMOD_MODE_NUM adspPostModeNum[ADSP_MAX_POST_MODES] = {POST_MODE1_ID};
...
ADSP_POSTMOD_NAME adspPostName[ADSP_MAX_POST_MODES] = {30012};
ADSP_POSTMOD_SETUP_NAME adspPostSetupName[ADSP_MAX_POST_MODES] = {30013};
ADSP_POSTMOD_DESCRIPTION adspPostDescription[ADSP_MAX_POST_MODES] = {30014};
ADSP_POSTMOD_HELP adspPostHelp[ADSP_MAX_POST_MODES] = {30015};

ADSP_POSTMOD_OWN_IMAGE adspPostOwnImage[ADSP_MAX_POST_MODES][AE_DSP_ADDON_STRING_LENGTH] = {"img1.jpg"};


// configuration for output resample
ADSP_OUTRESMOD_UNIQUEDBID adspOutResampleUniqueDdId = -1;
ADSP_OUTRESMOD_STR_NAMES adspOutResampleStrNames[AE_DSP_ADDON_STRING_LENGTH] = {"Output Resample Mode 1"};

ADSP_OUTRESMOD_MODE_NUM adspOutResampleModeNum = OUTPUT_RESAMPLE_ID;
